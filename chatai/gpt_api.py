...
class GptThread:
    ...
    def __init__(self, api_key: str = None, proxies: dict = None, time_out: int = None,
                 max_token: int = None, initial_prompt: str = None):
        """
        初始化
        :param api_key:
        :param proxies:
        ...
        """
        self.initial_prompt = env.str("CHATGPT_INITIAL_PROMPT_2", default=initial_prompt)
        self.time_out = env.int("CHATGPT_TIMEOUT", default=time_out)
        self.max_token = env.int("CHATGPT_MAX_TOKEN", default=max_token)
        openai.proxy = env.json("CHATGPT_PROXIES", default=proxies)
        openai.api_key = env.str("CHATGPT_KEY", default=api_key)
        self.msg = []
        self.reset_msg()
    ...
    def a_message_was_received_from_the_api(self,message):
        """
    ...
    def get_resp(self,message):
        ...
        try:
            ...
            resp = self.a_message_was_received_from_the_api(message)
